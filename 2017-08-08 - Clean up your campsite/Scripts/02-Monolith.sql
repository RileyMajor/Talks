...
DROP PROCEDURE IF EXISTS sp_send_dbmail_pretend;
GO

CREATE PROCEDURE sp_send_dbmail_pretend
...
DROP PROCEDURE IF EXISTS MonolithProcessOrders;
GO

CREATE PROCEDURE MonolithProcessOrders
	...
	BEGIN
		...
		BEGIN
			...
			SET			OrderInvoiceAmount = @OrderGrossCharges,
						OrderInvoiceDate = SYSDATETIMEOFFSET()
			WHERE		OrderID = @OrderID;
