...
Monolith Comparison after Declare Hoist

We hoisted the declarations up to the top of the procedure.

That allowed us to see how the customer data could be gathered all at once.
